...
| --- | --- | --- | --- | --- | --- | --- |
| Pose rule (frozen amplitude) | EMOCA/FLAME rotation | — | 0.64 | 0.70 | **0.67** | [0.35, 0.87] |
| Pose 1D CNN (xyz + derivatives) | EMOCA/FLAME rotation | 80 pseudo | 0.70 | 0.70 | **0.70** | [0.40, 0.89] |
